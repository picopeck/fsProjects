...
char* radioTags[] = {"RS_TEST_BUTTON", "RS_TRANSFER_BUTTON", "RS_FREQUENCY_UP", "RS_FREQUENCY_DOWN", "COMM1_SELECTED", "COMM2_SELECTED", "NAV1_SELECTED", "NAV2_SELECTED", "ADF_SELECTED", "XPDR_SELECTED", "RS_MHz_BUTTON"};
...
void loop()
{
    ...
    {
      autoPilotSwitches.printState(radioTags, NUMCONTACTS);    
